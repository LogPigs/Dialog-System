execute unless data storage dialog:temp temp_lineText.raw[0] run return run function dialog:textbox/choice/setlines/endline
...
execute if data storage dialog:temp {char:"\n"} run return run function dialog:textbox/choice/setlines/endline
...
execute unless score .int dialog.var matches ..-1 run return run function dialog:textbox/choice/setlines
...
execute if score .bool.1 dialog.var matches 0 run function dialog:textbox/choice/setlines/endline
