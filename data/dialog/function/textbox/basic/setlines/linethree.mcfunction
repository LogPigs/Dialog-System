...
$data modify storage dialog:temp lines.line3 set string storage dialog:temp shortString 64 $(shortLength)


function dialog:util/add_line_spaces {"input":"dialog:temp lines.line3","amount":"32"}
