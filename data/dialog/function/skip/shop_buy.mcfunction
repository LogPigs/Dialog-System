...
execute if entity @s[tag=skip_dialog] if score @s dialog.typewritelength = @s dialog.totallength run function dialog:player/get_buy with storage dialog:temp option
